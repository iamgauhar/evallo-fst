            ...
            <div className='h-screen flex justify-center items-center'>
                <div className="w-80 rounded-2xl bg-slate-100 m-auto">
                    <div className="flex flex-col gap-2 p-8">
                        ...
                        <input onChange={(e) => setEmail(e.target.value)} className="bg-slate-100 w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-1 focus:ring-gray-200 focus:ring-offset-2 focus:ring-offset-gray-300" type='email' placeholder="E-mail" />
